...
public class Traffic_act_ViewTabs extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ParkingFView(), "Parking Places");
        adapter.addFragment(new WaterLoggingsView(), "Water Loggins");
