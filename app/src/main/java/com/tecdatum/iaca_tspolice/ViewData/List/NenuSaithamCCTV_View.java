...
import com.tecdatum.iaca_tspolice.ViewData.Adapters.NenuSaitham_Adapter;
...
public class NenuSaithamCCTV_View extends AppCompatActivity {

    NenuSaitham_Adapter accidentAdapter;
    ArrayList<NenuSaitha_helper> arraylist = new ArrayList<NenuSaitha_helper>();
    ListView list_acc;
    TableRow tr_person;
    ...
    private static final String TAG = NenuSaithamCCTV_View.class.getSimpleName();
...
Spinner spin_ps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nenusaitham_cctv);
     ...
     //   CheckConnectivity1();
        ...
        btn_acc_reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                Intent i = new Intent(getApplicationContext(), NenuSaithamCCTV_View.class);
                startActivity(i);
...
//                        }
    ...
    private void setData() {
        ...
        if (isConnectingToInternet(NenuSaithamCCTV_View.this)) {
            CheckConnectivity2();
        }
    ...
    private void GetDataFromServer() {
        ...
        progressDialog = new ProgressDialog(NenuSaithamCCTV_View.this);
...
//            jsonBody.put("CCtvWorkingStatus_Id", cctvstatus_id);
            ...
            final String mRequestBody = jsonBody.toString();
            Log.e("VOLLEY", "Request:NenuSaithamcctvList" + mRequestBody);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, NenuSaithamcctvList, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Log.e("VOLLEY", "Response:NenuSaithamcctvList" + response);
                        JSONObject object=new JSONObject(response);
                        String code = object.optString("code").toString();
                        ...
                        if (code.equalsIgnoreCase("1")) {
                            ...
                            if (number == 0) {
                                ...
                                for( int i = 0; i < number; i++ ) {
                                    ...
                                    String VendorCompany = json_data.getString("VendorCompany").toString();
                                    String VendorAddress = json_data.getString("VendorAddress").toString();
                                    String VendorContactNo = json_data.getString("VendorContactNo").toString();
                                    String VendorName = json_data.getString("VendorName").toString();

                                  String CCTVWorkingStatus = json_data.getString("CCTVWorkingStatus").toString();
                                  String CCTVSpecifications = json_data.getString("CCTVSpecifications").toString();
                                  String CCTVType = json_data.getString("CCTVType").toString();
                                  //  String NoCameraInstalled = json_data.getString("NoCameraInstalled").toString();
                                    String StorageprovidedinDays = json_data.getString("StorageprovidedinDays").toString();
                                    String SectorId = json_data.getString("SectorId").toString();
                                    String ContactPersonNo = json_data.getString("ContactPersonNo").toString();
                                    String ContactPerson = json_data.getString("ContactPerson").toString();
                                    String NameOfEstablishment = json_data.getString("NameOfEstablishment").toString();
                                    String TypeOfEstablishment = json_data.getString("TypeOfEstablishment").toString();
                                    String PSName = json_data.getString("PSName").toString();
                                  String NoofCamerasInstalled = json_data.getString("NoofCamerasInstalled").toString();


                                    NenuSaitha_helper wp = new NenuSaitha_helper(PsID,PSName,CommunityGroup,SectorId,Locality,NoofCamerasInstalled,"",TypeOfEstablishment,NameOfEstablishment,ContactPerson,ContactPersonNo,Latitude
                                ...
                                accidentAdapter = new NenuSaitham_Adapter(NenuSaithamCCTV_View.this, arraylist);
                            ...
                            final AlertDialog.Builder alertDialog = new AlertDialog.Builder(NenuSaithamCCTV_View.this);
...
//                }
    ...
    private void alertDialogue_C1(int count) {
        C_dialog = new Dialog(NenuSaithamCCTV_View.this, R.style.MyAlertDialogStyle);
