 ...
 */
public class CustomYearPicker implements View.OnClickListener {
 ...
 //   private TimePicker timePicker;
    ...
    private EditText edt_set;

    private Calendar calendar_date = null;

    private Activity activity ,activity1;
    ...
    public CustomYearPicker(Activity a,
...
//        View dialogView1 = getDateTimePickerLayout1();
//        dialog1.setContentView(dialogView1);
    }

//    public View getDateTimePickerLayout1() {
...
//    }
    ...
    public View getDateTimePickerLayout() {
        ...
        btn_setDate = new Button(activity);
        btn_setDate.setLayoutParams(button_params);
        btn_setDate.setText("Set from Date");
        btn_setDate.setId(SET_DATE);
        btn_setDate.setOnClickListener(this);
    ...
    public void showDialog() {
        if (!dialog.isShowing()) {
            ...
            String Str1=  String.format("%02d:%02d %s", hour == 0 ? 12 : hour,
            ...
            datePicker.updateDate(calendar_date.get(Calendar.YEAR), 0, 0);
            ...
            case SET:
                if (iCustomDateTimeListener != null) {
                   ...
                   // int day = datePicker.getDayOfMonth();
                    ...
                    calendar_date.set(year,0, 0, selectedHour,
                            selectedMinute);
