...
public class Landmark_act extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private String TrafficList = URLS.TrafficList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lanmark);


        Bt_c_vl = (Button) findViewById(R.id.btn_lm_pk_vl);
        Bt_c_rest = (Button) findViewById(R.id.btn_lm_pk_reset);
        Bt_c_submit = (Button) findViewById(R.id.btn_lm_pk_submit);
        et_lm_nearest_Landmark = (EditText) findViewById(R.id.et_lm_nearest_Landmark);

        et_Landmark = (EditText) findViewById(R.id.et_lm_pk_Landmark);
        et_Locality = (EditText) findViewById(R.id.et_lm_pk_locality);
        et_Desriptn = (EditText) findViewById(R.id.et_lm_pk_Remarks);
        Category = (Spinner) findViewById(R.id.spin_lm_pk_it);
        subcat = (Spinner) findViewById(R.id.spin_lm_pk_vs);
        c_time = (TextView) findViewById(R.id.tv_lm_pk_time);
        tv_c_psname = (TextView) findViewById(R.id.tv_lm_pk_psname);
        R_subtype = (RelativeLayout) findViewById(R.id.Rl1);
        ...
        Bt_c_rest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
                Intent i = new Intent(getApplicationContext(), Landmark_act.class);
                startActivity(i);
                        ...
                        if (!(subcat.getSelectedItem().toString().trim() == "Select Vehicle Service Type")) {
                            if (!(et_Locality.getText().toString().trim().isEmpty())) {
                                if (!(et_Desriptn.getText().toString().trim().isEmpty())) {
                                    ...
                                    Toast.makeText(Landmark_act.this, "Please Enter Remarks", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(Landmark_act.this, "Location is mandatory", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(Landmark_act.this, "Select Vehicle Service Type", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(Landmark_act.this, "Select Vehicle Type", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
...
//            Longi= String.valueOf(0.0);
    ...
    private void AddTrafficDATA() {
        progressDialog = new ProgressDialog(Landmark_act.this);
                    ...
                    try {
                        ...
                        if (code != null) {
                            if (code.equalsIgnoreCase("1")) {
                                ...
                                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Landmark_act.this);
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(Landmark_act.this, "Server Error", Toast.LENGTH_SHORT).show();
                        }
...
//3-waterlogin type 4- waterlogin type
    ...
    private void VehicleData(ArrayList<Samplemyclass> str1) {
        ArrayAdapter<Samplemyclass> adapter = new ArrayAdapter<Samplemyclass>(Landmark_act.this, R.layout.spinner_item, str1);
...
//                }
    ...
    private void ServiceData(ArrayList<Samplemyclass> str1) {
        ArrayAdapter<Samplemyclass> adapter1 = new ArrayAdapter<Samplemyclass>(Landmark_act.this, R.layout.spinner_item, countryList1);
...
//                    }
    ...
    private void SetValuesToLayout() {
        ...
        vdialog = new Dialog(Landmark_act.this, R.style.HiddenTitleTheme);
...
//        TextView st5 = (TextView) vdialog.findViewById(R.id.tv_p5);
    ...
    private void alertDialogue_C1(int count) {
        C_dialog = new Dialog(Landmark_act.this, R.style.MyAlertDialogStyle);
    ...
    private void GetDataFromServer() {
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, TrafficList, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
