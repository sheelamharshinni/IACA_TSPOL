...
public class UpdateCrime_Acc extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final String TAG = UpdateCrime_Acc.class.getSimpleName();
    ...
    String yearid, yearName, item, item2, tv_Ad, tv_Long, tv_Lat, S_Descr, psJuri, S_Uname, S_Pass, s_Ps_name, S_longitude, S_latitude,
            Code_new,Message, Message1, S_detected_id, S_detected_, S_psid, s_role, S_IMEi, S_CrimeNo, S_dateTime, S_location,
    ...
    private void alertDialogue_Conform() {
        ...
        NotNull();
        C_dialog = new Dialog(UpdateCrime_Acc.this, R.style.MyAlertDialogStyle);
        ...
        if(crime_Type.equalsIgnoreCase("Accident")){
...
//
    ...
    private void SetValuesToLayout(int coun) {
        ...
        vdialog = new Dialog(UpdateCrime_Acc.this, R.style.HiddenTitleTheme);
...
//            });
    ...
    class GetAccidentDetails extends AsyncTask<Void, Void, Void> {
        private final ProgressDialog dialog = new ProgressDialog(UpdateCrime_Acc.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (timeoutexcep) {
                Toast.makeText(UpdateCrime_Acc.this, "Unable to connect to server, Please try again later", Toast.LENGTH_LONG).show();
            } else if (httpexcep) {
                Toast.makeText(UpdateCrime_Acc.this, "Please check your Internet connection", Toast.LENGTH_LONG).show();
            } else if (genexcep) {
                Toast.makeText(UpdateCrime_Acc.this, "Please try later", Toast.LENGTH_LONG).show();
            } else {
...
//   // getCrimeType_Api();
                    ...
                    try {
                        ...
                        if (code.equalsIgnoreCase("1")){
                            ...
                            if (number == 0) {
                                ...
                                Samplemyclass wp0 = new Samplemyclass("0", "Select Crime No");
    ...
    private void SendDataToServer() {
        progressDialog = new ProgressDialog(UpdateCrime_Acc.this);
        progressDialog.setMessage("Loading, Please Wait...");
        progressDialog.show();
        JSONObject jsonBody = new JSONObject();
        try {
            jsonBody.put("CrimeID", Cat1);
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (code.equalsIgnoreCase("1")){
                            ...
                            tr_crimedate.setVisibility(View.GONE);
                            tr_crimesubtype.setVisibility(View.GONE);
                            final AlertDialog.Builder alertDialog = new AlertDialog.Builder(UpdateCrime_Acc.this);
