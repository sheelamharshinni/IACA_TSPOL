package com.tecdatum.iaca_tspolice.activity.DataEntryView;
...
import com.tecdatum.iaca_tspolice.activity.LoginActivity;
...
public class Dataview extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//                    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Accident) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddAccident.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddAccident.class));
            }
        ...
        if (id == R.id.nav_CCTV) {
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    startActivity(new Intent(Dataview.this, CCtv_Tabs.class));
                } else {
                    Toast.makeText(getApplicationContext(), "Access Denied", Toast.LENGTH_SHORT).show();
                }
            } else {
        ...
        if (id == R.id.nav_pCCTV) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddPCCTV.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddPCCTV.class));
            }
        ...
        if (id == R.id.nav_Landmarks) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, Landmark_act.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, Landmark_act.class));
            }
        ...
        if (id == R.id.nav_hp) {
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddHp.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddHp.class));
            }
        ...
        if (id == R.id.nav_History) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddHistorySheets.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddHistorySheets.class));
            }
        ...
        if (id == R.id.nav_Religious) {
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddReligious.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddReligious.class));
            }
        ...
        if (id == R.id.nav_update) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, UpdateCrime_Acc.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, UpdateCrime_Acc.class));
            }
        ...
        if (id == R.id.nav_crime1) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddCrime_View.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddCrime_View.class));
            }
        ...
        if (id == R.id.nav_Accident1) {
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddAccident_View.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddAccident_View.class));
            }
        ...
        if (id == R.id.nav_CCTV1) {
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    if (CPControlID.equalsIgnoreCase("1")) {
                        startActivity(new Intent(Dataview.this, CCtv_View.class));
                    } else {
                        Intent intent = new Intent(getApplicationContext(), CCtv_View.class);
                        startActivity(intent);
                    }
        ...
        if (id == R.id.nav_Landmarks1) {
            ...
            if (S_Orgid.equalsIgnoreCase("31")) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, Traffic_act_ViewTabs.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, Traffic_act_ViewTabs.class));
            }
        ...
        if (id == R.id.nav_History1) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddHistorySheets_View.class));
                }
            } else {
                startActivity(new Intent(Dataview.this, AddHistorySheets_View.class));
            }
        ...
        if (id == R.id.nav_Religious1) {
            ...
            if (S_Orgid.equalsIgnoreCase("31") ) {
                if (S_LevelId.equalsIgnoreCase("2")) {
                    ...
                    startActivity(new Intent(Dataview.this, AddReligious_View.class));;
                }
            } else {
                startActivity(new Intent(Dataview.this, AddReligious_View.class));
            }
        ...
        if (id == R.id.nav_resetpassword) {
            startActivity(new Intent(Dataview.this, ResetPassword.class));
        }

        if (id == R.id.nav_contact) {
            startActivity(new Intent(Dataview.this, ContactUs.class));
        }
